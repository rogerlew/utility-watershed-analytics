...
SCRIPT = REPOSITORY_ROOT / "scripts" / "accept_rhessys_artifacts.py"


class RhessysAcceptanceTests(unittest.TestCase):
    def test_wrapper_passes_and_removes_temporary_subtree(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(result["removed_capabilities"], ["example-north"])
