...
| [20260716-db04-legacy-loader-guardrails](20260716-db04-legacy-loader-guardrails/package.md) | DB04 | `SCAFFOLDED` | DB02 and DB03/DB03A dependencies are complete; repository implementation is the next bounded wave and remains unauthorized. |
| [20260716-db05-named-postgres-volume-cutover](20260716-db05-named-postgres-volume-cutover/package.md) | DB05 | `SCAFFOLDED` | Not authorized; blocked on DB04, rehearsal, accepted RTO, and production cutover authority. |
