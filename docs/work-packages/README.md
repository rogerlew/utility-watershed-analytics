...
| [20260717-db03a-production-runner-ownership-closure](20260717-db03a-production-runner-ownership-closure/package.md) | DB03A | `SCAFFOLDED` | Authorized closure: fast-forward the fork's `main`, securely configure its production secret, register a new fork-owned runner, and prove production unchanged without dispatching a workflow. |
