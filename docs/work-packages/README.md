...
| [20260717-db10-artifact-store-contract](20260717-db10-artifact-store-contract/package.md) | DB10 | `EXECUTED-COMPLETE` | Backblaze B2 selection, private test/production buckets, SSE-B2, 365-day COMPLIANCE lock, five roles, active-plus-two retention/mirror, six artifact classes, nine threat cases, and ten fail-closed tests passed without provisioning infrastructure. |
