...
| [20260716-db05-named-postgres-volume-cutover](20260716-db05-named-postgres-volume-cutover/package.md) | DB05 | `EXECUTED-HOLD-PUBLISH` | Rehearsal and production named-volume cutover, rollback/reapply, persistence/reboot, fork checkout convergence, encrypted pre/post backup, exact fingerprints, and isolated restore passed; agent commit `2c6f426...` is published while fork `main` and clean production fast-forward remain. |
