...
| [20260716-db05-named-postgres-volume-cutover](20260716-db05-named-postgres-volume-cutover/package.md) | DB05 | `SCAFFOLDED` | Dependencies complete but not authorized; blocked on production-shaped rehearsal, accepted cutover inputs/RTO, and explicit production authority. |
