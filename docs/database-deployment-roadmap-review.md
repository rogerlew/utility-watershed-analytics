...
| O9 | Medium | The artifact backup contract required acceptance against real infrastructure rather than documentation alone. | Accepted as amended by operator authority. DB10A provisions the real `forest1:/wc1` paths and proves private modes, content integrity, capacity failure, idempotent copy, and clean restoration of three releases. DB12 depends on it. |
